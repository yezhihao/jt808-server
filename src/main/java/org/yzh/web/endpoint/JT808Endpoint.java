...
public class JT808Endpoint {
    ...
    public Object send(PackageData<Header> packageData, boolean hasReplyFlowIdId) {
        ...
        Session session = sessionManager.findByTerminalId(phoneNumber);
        ...
        String key = phoneNumber + (hasReplyFlowIdId ? header.getFlowId() : "");
    ...
    public void 终端通用应答(CommonResult packageData) {
        ...
        messageManager.put(phoneNumber + replyId, packageData);
    }
    ...
    public void 查询终端属性应答(TerminalAttributeReply packageData) {
        Header header = packageData.getHeader();
        String phoneNumber = header.getPhoneNumber();
        messageManager.put(phoneNumber, packageData);
    }
    ...
    public CommonResult heartBeat(PackageData<Header> packageData, Session session) {
        Header header = packageData.getHeader();
        Header resultHeader = new Header(平台通用应答, session.currentFlowId(), header.getPhoneNumber());
        //TODO
    ...
    public RegisterResult register(Register packageData, Session session) {
        Header header = packageData.getHeader();
        Header resultHeader = new Header(终端注册应答, session.currentFlowId(), header.getPhoneNumber());
        //TODO
        session.setTerminalId(header.getPhoneNumber());
