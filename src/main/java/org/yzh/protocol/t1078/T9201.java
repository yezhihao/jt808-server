...
public class T9201 extends JTMessage {
    ...
    @Field(index = 9, type = DataType.BYTE, desc = "回放方式: 0.正常回放 1.快进回放 2.关键帧快退回放 3.关键帧播放 4.单帧上传")
    private int playbackMode;
    @Field(index = 10, type = DataType.BYTE, desc = "快进或快退倍数: 0.无效 1.1倍 2.2倍 3.4倍 4.8倍 5.16倍 (回放控制为1和2时,此字段内容有效,否则置0)")
