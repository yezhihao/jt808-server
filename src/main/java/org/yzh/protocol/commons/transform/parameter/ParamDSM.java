...
public class ParamDSM {
    ...
    private byte p46 = -1;
    @Schema(description = "摄像机遮挡报警分级速度阈值(粤标)")
    private byte p47 = -1;
    @Schema(description = "不系安全带报警分级速度阈值(粤标)")
    private byte p48 = -1;
    @Schema(description = "不系安全带报警前后视频录制时间(粤标)")
    private byte p49 = -1;
    @Schema(description = "不系安全带报警抓拍照片张数(粤标)")
    private byte p50 = -1;
    @Schema(description = "不系安全带报警抓拍照片间隔时间(粤标)")
    private byte p51 = -1;
    @Schema(description = "红外墨镜阻断失效报警分级速度阈值(粤标)")
    private byte p52 = -1;
    @Schema(description = "红外墨镜阻断失效报警前后视频录制时间(粤标)")
    private byte p53 = -1;
    @Schema(description = "红外墨镜阻断失效报警抓拍照片张数(粤标)")
    private byte p54 = -1;
    @Schema(description = "红外墨镜阻断失效报警抓拍照片间隔时间(粤标)")
    private byte p55 = -1;
    @Schema(description = "双脱把报警分级速度阈值(粤标)")
    private byte p56 = -1;
    @Schema(description = "双脱把报警前后视频录制时间(粤标)")
    private byte p57 = -1;
    @Schema(description = "双脱把报警抓拍照片张数(粤标)")
    private byte p58 = -1;
    @Schema(description = "双脱把报警抓拍照片间隔时间(粤标)")
    private byte p59 = -1;
    @Schema(description = "玩手机报警分级速度阈值(粤标)")
    private byte p60 = -1;
    @Schema(description = "玩手机报警前后视频录制时间(粤标)")
    private byte p61 = -1;
    @Schema(description = "玩手机报警抓拍照片张数(粤标)")
    private byte p62 = -1;
    @Schema(description = "玩手机报警拍抓拍，照片间隔时间(粤标)")
    private byte p63 = -1;
    @Schema(description = "保留字段(粤标)")
    private byte p64 = -1;
