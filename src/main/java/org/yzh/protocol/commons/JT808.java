...
public interface JT808 {
    ...
    int 终端心跳 = 0x0002;
    int 终端注销 = 0x0003;
    int 查询服务器时间 = 0x0004;//2019
    int 终端补传分包请求 = 0x0005;//2019
    int 终端注册 = 0x0100;
    int 终端鉴权 = 0x0102;
    int 查询终端参数应答 = 0x0104;
    int 查询终端属性应答 = 0x0107;
    ...
    int 临时位置跟踪控制 = 0x8202;
    int 人工确认报警消息 = 0x8203;
    int 服务器向终端发起链路检测请求 = 0x8204;//2019
    int 文本信息下发 = 0x8300;
    int 事件设置 = 0x8301;
    int 提问下发 = 0x8302;
    int 信息点播菜单设置 = 0x8303;
    ...
    int 厂商自定义上行消息 = 0xE000 - 0xEFFF;//2019
    int 商自定义下行消息 = 0xF000 - 0xFFFF;//2019
