...
//
//    @Override
//    public Object read(ByteBuf buf, FieldMetadata field, int length) {
//        int before = buf.readerIndex();
//        Object value = super.read(buf, field, length);
//        int after = buf.readerIndex();
//
//        String hex = ByteBufUtil.hexDump(buf.slice(before, after - before));
//        System.out.println(field.index + "\t" + hex + "\t" + field.desc + "\t" + (value.getClass().isArray() ? ArrayUtils.toString(value) : value));
//        return value;
//    }
//}