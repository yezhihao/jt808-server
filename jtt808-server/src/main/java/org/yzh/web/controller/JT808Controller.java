...
public class JT808Controller {
    ...
    public Mono<APIResult<T0001>> setParameters(@Parameter(description = "终端手机号") @RequestParam String mobileNo, @RequestBody Parameters parameters) {
    ...
    @PostMapping("control")
    public Mono<APIResult<T0001>> deviceControl(@Parameter(description = "终端手机号") @RequestParam String mobileNo, T8105 request) {
        Mono<APIResult<T0001>> response = messageManager.requestR(mobileNo, request, T0001.class);
        return response;
    }
    ...
    @GetMapping("location")
    public Mono<APIResult<T0201_0500>> location(@Parameter(description = "终端手机号") @RequestParam String mobileNo) {
        Mono<APIResult<T0201_0500>> response = messageManager.requestR(mobileNo, new JTMessage(JT808.位置信息查询), T0201_0500.class);
        return response;
    }

    @Operation(summary = "8202 临时位置跟踪控制")
    @PostMapping("location/track")
    public Mono<APIResult<T0001>> track(@Parameter(description = "终端手机号") @RequestParam String mobileNo, T8202 request) {
        Mono<APIResult<T0001>> response = messageManager.requestR(mobileNo, request, T0001.class);
        return response;
    }
    ...
    public Mono<APIResult<T0001>> alarmAck(@Parameter(description = "终端手机号") @RequestParam String mobileNo, T8203 request) {
        Mono<APIResult<T0001>> response = messageManager.requestR(mobileNo, request, T0001.class);
        return response;
    }
    ...
    public Mono<APIResult<T0001>> sendText(@Parameter(description = "终端手机号") @RequestParam String mobileNo, T8300 request) {
        Mono<APIResult<T0001>> response = messageManager.requestR(mobileNo, request, T0001.class);
        return response;
    }
    ...
    public Mono<APIResult<T0001>> setEvents(@Parameter(description = "终端手机号") @RequestParam String mobileNo, @RequestBody T8301 request) {
        Mono<APIResult<T0001>> response = messageManager.requestR(mobileNo, request, T0001.class);
        return response;
    }
    ...
    public Mono<APIResult<T0001>> sendQuestion(@Parameter(description = "终端手机号") @RequestParam String mobileNo, @RequestBody T8302 request) {
        Mono<APIResult<T0001>> response = messageManager.requestR(mobileNo, request, T0001.class);
        return response;
    }
    ...
    public Mono<APIResult<T0001>> setMenus(@Parameter(description = "终端手机号") @RequestParam String mobileNo, @RequestBody T8303 request) {
        Mono<APIResult<T0001>> response = messageManager.requestR(mobileNo, request, T0001.class);
        return response;
    }
    ...
    public Mono<APIResult<T0001>> sendNews(@Parameter(description = "终端手机号") @RequestParam String mobileNo, T8304 request) {
        Mono<APIResult<T0001>> response = messageManager.requestR(mobileNo, request, T0001.class);
        return response;
    }
    ...
    public Mono<APIResult<T0001>> phoneCallBack(@Parameter(description = "终端手机号") @RequestParam String mobileNo, T8400 request) {
        Mono<APIResult<T0001>> response = messageManager.requestR(mobileNo, request, T0001.class);
        return response;
    }
    ...
    public Mono<APIResult<T0001>> setPhoneBook(@Parameter(description = "终端手机号") @RequestParam String mobileNo, @RequestBody T8401 request) {
        Mono<APIResult<T0001>> response = messageManager.requestR(mobileNo, request, T0001.class);
        return response;
    }
    ...
    public Mono<APIResult<T0201_0500>> vehicleControl(@Parameter(description = "终端手机号") @RequestParam String mobileNo, T8500 request) {
        Mono<APIResult<T0201_0500>> response = messageManager.requestR(mobileNo, request, T0201_0500.class);
        return response;
    }

    @Operation(summary = "8600 设置圆形区域")
    @PutMapping("area/circle")
    public Mono<APIResult<T0001>> setAreaCircle(@Parameter(description = "终端手机号") @RequestParam String mobileNo, @RequestBody T8600 request) {
        Mono<APIResult<T0001>> response = messageManager.requestR(mobileNo, request, T0001.class);
        return response;
    }
    ...
    public Mono<APIResult<T0001>> setAreaRectangle(@Parameter(description = "终端手机号") @RequestParam String mobileNo, @RequestBody T8602 request) {
        Mono<APIResult<T0001>> response = messageManager.requestR(mobileNo, request, T0001.class);
        return response;
    }
    ...
    public Mono<APIResult<T0001>> setAreaPolygon(@Parameter(description = "终端手机号") @RequestParam String mobileNo, @RequestBody T8604 request) {
        Mono<APIResult<T0001>> response = messageManager.requestR(mobileNo, request, T0001.class);
        return response;
    }
    ...
    public Mono<APIResult<T0001>> setAreaRoute(@Parameter(description = "终端手机号") @RequestParam String mobileNo, @RequestBody T8606 request) {
        Mono<APIResult<T0001>> response = messageManager.requestR(mobileNo, request, T0001.class);
        return response;
    }
    ...
    @DeleteMapping("area")
    public Mono<APIResult<T0001>> removeArea(@Parameter(description = "终端手机号") @RequestParam String mobileNo,
    ...
    public Mono<APIResult<T0608>> findAreaLocation(@Parameter(description = "终端手机号") @RequestParam String mobileNo,
                                                   @Parameter(description = "查询类型：1.圆形 2.矩形 3.多边形 4.路线") @RequestParam int type,
                                                   @Parameter(description = "区域ID列表(多个以逗号','分隔)") @RequestParam int[] id) {
        T8608 request = new T8608(type, id);
        Mono<APIResult<T0608>> response = messageManager.requestR(mobileNo, request, T0608.class);
        return response;
    }

    @Operation(summary = "8700 行驶记录仪数据采集命令")
    @GetMapping("drive_recorder/data")
    public Mono<APIResult<T0001>> getDriveRecorder(@Parameter(description = "终端手机号") @RequestParam String mobileNo) {
        Mono<APIResult<T0001>> response = messageManager.requestR(mobileNo, new JTMessage(JT808.行驶记录仪数据采集命令), T0001.class);
        return response;
    }

    @Operation(summary = "8701 行驶记录仪参数下传命令")
    @PutMapping("drive_recorder/parameters")
    public Mono<APIResult<T0001>> setDriveRecorderParameters(@Parameter(description = "终端手机号") @RequestParam String mobileNo, T8701 request) {
        Mono<APIResult<T0001>> response = messageManager.requestR(mobileNo, request, T0001.class);
        return response;
    }
    ...
    public Mono<APIResult<T0702>> driverInfoUpload(@Parameter(description = "终端手机号") @RequestParam String mobileNo) {
        Mono<APIResult<T0702>> response = messageManager.requestR(mobileNo, new JTMessage(JT808.上报驾驶员身份信息请求), T0702.class);
        return response;
    }

    @Operation(summary = "8801 摄像头立即拍摄命令")
    @PostMapping("media/video/record")
    public Mono<APIResult<T0805>> mediaVideoRecord(@Parameter(description = "终端手机号") @RequestParam String mobileNo, T8801 request) {
        Mono<APIResult<T0805>> response = messageManager.requestR(mobileNo, request, T0805.class);
        return response;
    }

    @Operation(summary = "8802 存储多媒体数据检索")
    @GetMapping("media/search")
    public Mono<APIResult<T0802>> mediaSearch(@Parameter(description = "终端手机号") @RequestParam String mobileNo, T8802 request) {
        Mono<APIResult<T0802>> response = messageManager.requestR(mobileNo, request, T0802.class);
        return response;
    }

    @Operation(summary = "8803 存储多媒体数据上传")
    @PostMapping("media/batch_upload")
    public Mono<APIResult<T0001>> mediaUploadBatch(@Parameter(description = "终端手机号") @RequestParam String mobileNo, T8803 request) {
        Mono<APIResult<T0001>> response = messageManager.requestR(mobileNo, request, T0001.class);
        return response;
    }
    ...
    public Mono<APIResult<T0001>> mediaAudioRecord(@Parameter(description = "终端手机号") @RequestParam String mobileNo, T8804 request) {
        Mono<APIResult<T0001>> response = messageManager.requestR(mobileNo, request, T0001.class);
        return response;
    }
    ...
    public Mono<APIResult<T0001>> mediaUpload(@Parameter(description = "终端手机号") @RequestParam String mobileNo, T8805 request) {
        Mono<APIResult<T0001>> response = messageManager.requestR(mobileNo, request, T0001.class);
        return response;
    }
    ...
    @PostMapping("upgrade")
    public Mono<APIResult<T0001>> upgrade(@Parameter(description = "终端手机号") @RequestParam String mobileNo, T8108 request) {
        Mono<APIResult<T0001>> response = messageManager.requestR(mobileNo, request, T0001.class);
        return response;
    }
    ...
    public Mono<APIResult<T0001>> passthrough(@Parameter(description = "终端手机号") @RequestParam String mobileNo, Passthroughs passthroughs) {
    ...
    public Mono<APIResult<T0A00_8A00>> rsaSwap(@Parameter(description = "终端手机号") @RequestParam String mobileNo,
        ...
        Mono<APIResult<T0A00_8A00>> response = messageManager.requestR(mobileNo, request, T0A00_8A00.class);
        return response;
    }
}